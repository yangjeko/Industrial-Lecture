...
인공지능이란 ( artificial intelligence) 
	ㄴ 깊은 신경망의 성장 요인,발달 방향
 Information > Learning > Knowledge > Intelligence

앞으로 인공지능의 성숙을 이끄는 핵심 동력
	ㄴ Algorithms, Information Explosion, Connectivity, Increased Compute
...
스타트업 - 주요 사업 분야 ( 2018년 )
	  ㄴ 가상보안, 의료, 기업지원  > 인공지능을 적용하여 가시적 성과를 낼수 있는 분야로 구체화됨

나는 무엇을 해야하나?
	ㄴ 인식의 변화 대응 (가치의 충돌, 경계의 붕괴), 산업 대변혁 촉발, 대대적 일자리 변화, 삶, 환경 변화

주요 산업별 요구되는 직무 역량 변화
	ㄴ Complex Problem Solving, Cognitive Abilities
